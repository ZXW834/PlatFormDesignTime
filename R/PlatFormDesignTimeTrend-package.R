#' The 'PlatFormDesignTimeTrend' package.
#'
...
#'
#' @docType package
#' @name PlatFormDesignTimeTrend-package
#' @aliases PlatFormDesignTimeTrend
#' @useDynLib PlatFormDesignTimeTrend, .registration = TRUE
#' @import methods
#' @import Rcpp

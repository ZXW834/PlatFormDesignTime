...
#'
#' @return A vector of recommended cutoff. The final value is the latest recommended value.
...
#' cl = 2)
#'
#' #[1] 0.9953 0.9944 0.9937 0.9942 0.9947 0.9943 0.9939 0.9942 0.9939
#' #    0.9937 0.9934 0.9932 0.9929 0.9927 0.9929
Cutoffscreening = function(ntrials = 5000,
                           trial.fun = simulatetrial,
                           grid.inf = list(start = c(0.9, 0.95, 1), extendlength =
                                             15),
                           input.info = list(
